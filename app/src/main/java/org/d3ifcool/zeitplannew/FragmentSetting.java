...
public class FragmentSetting extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        toasts.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) { //set onClick pada Card nya
                composeEmail(new String[]{"ilhampersatu1972@gmail.com"},"[Ada saran untuk kelompok 6?]");
            }
        });
        ...
        contactEmail.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) { //set onClick pada Card nya
                contactEmail(new String[]{"ilhampersatu1972@gmail.com"});
            }
        });
...
//        Log.d("LoadPreferences",String.valueOf(switchOnOff));
    ...
    private void intentWhatsapp(){
        try{
            String toNumber = "+62 82143649688"; // contains spaces.
            toNumber = toNumber.replace("+", "").replace(" ", "");
            Intent sendIntent = new Intent("android.intent.action.MAIN");
            // sendIntent.setComponent(new ComponentName(“com.whatsapp”, “com.whatsapp.Conversation”));
            sendIntent.putExtra("jid", toNumber + "@s.whatsapp.net");
            sendIntent.setAction(Intent.ACTION_SEND);
            sendIntent.putExtra(Intent.EXTRA_TEXT,"Selamat datang! Perkenalkan nama saya Ilham Bagus Bahrudin [NIM 18532939 , Kelas TI5B] kami dari kelompok 6. Ada saran?");
    ...
    private void intentWhatsapp2(){
        try{
            String toNumber = "+62 81244289080"; // contains spaces.
            toNumber = toNumber.replace("+", "").replace(" ", "");
            Intent sendIntent = new Intent("android.intent.action.MAIN");
            // sendIntent.setComponent(new ComponentName(“com.whatsapp”, “com.whatsapp.Conversation”));
            sendIntent.putExtra("jid", toNumber + "@s.whatsapp.net");
            sendIntent.setAction(Intent.ACTION_SEND);
            sendIntent.putExtra(Intent.EXTRA_TEXT,"Selamat datang! Perkenalkan nama saya Moh. Ridho Abdul Hakim [NIM 18532935 , Kelas TI5B] kami dari kelompok 6. Ada saran?");
            sendIntent.setPackage("com.whatsapp");
            sendIntent.setType("text/plain");
            startActivity(sendIntent);
        }catch (Exception e){
    ...
    private void intentWhatsapp3(){
        try{
            String toNumber = "+62 881026698135"; // contains spaces.
            toNumber = toNumber.replace("+", "").replace(" ", "");
            Intent sendIntent = new Intent("android.intent.action.MAIN");
            // sendIntent.setComponent(new ComponentName(“com.whatsapp”, “com.whatsapp.Conversation”));
            sendIntent.putExtra("jid", toNumber + "@s.whatsapp.net");
            sendIntent.setAction(Intent.ACTION_SEND);
            sendIntent.putExtra(Intent.EXTRA_TEXT,"Selamat datang! Perkenalkan nama saya Kurniawan Yuwono Putra [NIM 18532932 , Kelas TI5B] kami dari kelompok 6. Ada saran?");
            sendIntent.setPackage("com.whatsapp");
            sendIntent.setType("text/plain");
            startActivity(sendIntent);
        }catch (Exception e){
    ...
    private void dialogDeleteAll(){
        ...
        builder.setPositiveButton("Hapus", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (rowDeleted == 0){
                    Toasty.error(appContext,"Gagal Menghapus Jadwal",Toasty.LENGTH_SHORT).show();
                }else{
                    Toasty.success(appContext,"Semua Jadwal Terhapus",Toasty.LENGTH_SHORT).show();
                }
            }
        });
